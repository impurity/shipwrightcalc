...
Public Class Form1
    ...
    'Sets Maximum values for each item
    Private Sub ShipTypeCombo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ShipTypeCombo.SelectedIndexChanged
        Select Case ShipTypeCombo.SelectedIndex
            Case 0 'Raft
                TrackCeiling.Enabled = False
                TrackSmallSail.Enabled = False
                TrackMediumSail.Enabled = False
                TrackLargeSail.Enabled = False
                TrackGunport.Enabled = False
                TrackMediumCannon.Enabled = False
                TrackLargeCannon.Enabled = False
                TrackSwivel.Enabled = False
                TrackMortar.Enabled = False
            Case 1 'Dingy
                TrackCeiling.Enabled = False
                TrackSmallSail.Enabled = False
                TrackMediumSail.Enabled = False
                ...
                TrackMortar.Enabled = False
            Case 2 'Sloop
                TrackCeiling.Enabled = True
                TrackCeiling.Maximum = 6
                TrackSmallSail.Enabled = True
                TrackSmallSail.Maximum = 2
                TrackMediumSail.Enabled = True
                TrackMediumSail.Maximum = 1
                TrackLargeSail.Enabled = False
                TrackGunport.Enabled = False
                TrackMediumCannon.Enabled = False
                TrackLargeCannon.Enabled = False
            ...
            Case 3 'Schooner
                TrackCeiling.Enabled = True
                TrackCeiling.Maximum = 32
                TrackSmallSail.Enabled = True
                TrackSmallSail.Maximum = 4
                TrackMediumSail.Enabled = True
                TrackMediumSail.Maximum = 2
                TrackLargeSail.Enabled = True
                TrackLargeSail.Maximum = 1
                TrackGunport.Enabled = True
                TrackGunport.Maximum = 10
                TrackMediumCannon.Enabled = True
                TrackMediumCannon.Maximum = 10
                TrackLargeCannon.Enabled = False
                TrackSwivel.Enabled = False
                TrackMortar.Enabled = False
            Case 4 'Brigatine
                TrackCeiling.Enabled = True
                TrackCeiling.Maximum = 36
                TrackSmallSail.Enabled = True
                TrackSmallSail.Maximum = 5
                TrackMediumSail.Enabled = True
                TrackMediumSail.Maximum = 5
                TrackLargeSail.Enabled = True
                TrackLargeSail.Maximum = 3
                TrackGunport.Enabled = True
                TrackGunport.Maximum = 12
                TrackMediumCannon.Enabled = True
                TrackMediumCannon.Maximum = 12
                TrackLargeCannon.Enabled = True
                TrackLargeCannon.Maximum = 2
                TrackSwivel.Enabled = True
                TrackSwivel.Maximum = 2
                TrackMortar.Enabled = True
                TrackMortar.Maximum = 1
            Case 5 'Galleon
                TrackSmallSail.Maximum = 0
                TrackMediumSail.Maximum = 0
                TrackLargeSail.Maximum = 0
                TrackGunport.Maximum = 0
                TrackMediumCannon.Maximum = 0
                TrackLargeCannon.Maximum = 0
                TrackSwivel.Maximum = 0
                TrackMortar.Maximum = 0
        End Select
    End Sub

    Private Sub OutputTypeCombo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles OutputTypeCombo.SelectedIndexChanged
        Select Case OutputTypeCombo.SelectedIndex
            Case 0 'Rigging
            ...
            Case 8 'Everything
                SetOutput(CalculateOutput(ShipTypeCombo.Text, OutputTypeCombo.Text))
        End Select
    End Sub

    Private Sub SetOutput(ByVal values() As String)
        OutputWood.Text = values(0)
        OutputThatch.Text = values(1)
        OutputFiber.Text = values(2)
        OutputMetal.Text = values(3)
        OutputHide.Text = values(4)
        OutputCoal.Text = values(5)
        OutputAlloy.Text = values(6)
    End Sub

    Private Function CalculateOutput(ByVal shiptype As String, ByVal outputtype As String)
        Dim output(6) As String
        'Wood0 Thatch1 Fiber2 Metal3 Hide4 Coal5 Alloy6 is the order for output
    ...
    Private Sub TrackCeiling_Scroll(sender As Object) Handles TrackCeiling.Scroll
        CeilingCount.Value1 = TrackCeiling.Value
    End Sub

    Private Sub TrackSmallSail_Scroll(sender As Object) Handles TrackSmallSail.Scroll
        SmallSailCount.Value1 = TrackSmallSail.Value
    End Sub

    Private Sub TrackMediumSail_Scroll(sender As Object) Handles TrackMediumSail.Scroll
        MediumSailCount.Value1 = TrackMediumSail.Value
    End Sub

    Private Sub TrackLargeSail_Scroll(sender As Object) Handles TrackLargeSail.Scroll
        LargeSailCount.Value1 = TrackLargeSail.Value
    End Sub

    Private Sub TrackGunport_Scroll(sender As Object) Handles TrackGunport.Scroll
        GunportCount.Value1 = TrackGunport.Value
    End Sub

    Private Sub TrackMediumCannon_Scroll(sender As Object) Handles TrackMediumCannon.Scroll
        MediumCannonCount.Value1 = TrackMediumCannon.Value
    End Sub

    Private Sub TrackLargeCannon_Scroll(sender As Object) Handles TrackLargeCannon.Scroll
        LargeCannonCount.Value1 = TrackLargeCannon.Value
    End Sub

    Private Sub TrackSwivel_Scroll(sender As Object) Handles TrackSwivel.Scroll
        SwivelCount.Value1 = TrackSwivel.Value
    End Sub

    Private Sub TrackMortar_Scroll(sender As Object) Handles TrackMortar.Scroll
        MortarCount.Value1 = TrackMortar.Value
    End Sub
End Class
